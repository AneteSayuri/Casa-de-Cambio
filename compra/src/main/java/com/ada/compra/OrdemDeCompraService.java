...
public class OrdemDeCompraService {
    ...
    private CotacaoAPIClient cotacaoAPIClient;
    ...
    public OrdemDeCompra criarOrdemDeCompra (OrdemDeCompra entity) throws EntidadeDuplicadaException, ClienteInvalidoException, MoedaInvalidaException, AgenciaInvalidaException, ValorInvalidoException, InvalidRegistrationException {
//        SÓ FUNCIONA SE PASSAR ID NO POSTMAN
...
//        ESSA VALIDAÇÃO NÃO ESTÁ DEIXANDO O CÓDIGO RODAR
